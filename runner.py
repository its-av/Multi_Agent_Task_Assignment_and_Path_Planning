...
from prioritised import PrioritizedPlanningSolver
from visualize import Animation
from path_astar_one import get_sum_of_cost, path
import itertools
import heapq
...
my_map, agent_loc,task_start, task_goal,a,t = read_input('./cases/test_1.txt')
...
my_map, agent_loc,task_start, task_goal,a,t = read_input('./cases/test_2.txt')
print("Total Agents = {}".format(len(agent_loc)))
print("Total Tasks = {}".format(len(task_start)))
prep_a=[]
...
for i in range(len(agent_loc)):
    ...
    if(zz[0]>=yy[0]):
        ...
        aasn_task.append(zz[1])
    else:
        break
for j in range(len(task_start)):
    if j not in aasn_task:
        rem_task.append(task_start[j])
...
print("***Test paths on a simulation***")
print('Tasks Completed')
animation = Animation(my_map, fff, hhh, paths1,ggg,rem_task)
animation.show()

print("Case 3: PickUp And Delivery of Multiple Task")
my_map, agent_loc,task_start, task_goal,a,t = read_input('./cases/test_3.txt')
print("Total Agents = {}".format(len(agent_loc)))
print("Total Tasks = {}".format(len(task_start)))
...
my_map, agent_loc,task_start, task_goal,a,t = read_input('./cases/misc.txt')
print("Total Agents = {}".format(len(agent_loc)))
print("Total Tasks = {}".format(len(task_start)))
paths1,cost = min_cost_task_assn(agent_loc, task_start)
ttt=[]
...
print("Case 5: Miscellaneous Warehouse 2 Using Prioritised")
my_map, agent_loc,task_start, task_goal,a,t = read_input('./cases/misc2.txt')
print("Total Agents = {}".format(len(agent_loc)))
print("Total Tasks = {}".format(len(task_start)))
solver = PrioritizedPlanningSolver(my_map, agent_loc, task_start)
paths1 = solver.find_solution()
solver = PrioritizedPlanningSolver(my_map, task_start, task_goal)
